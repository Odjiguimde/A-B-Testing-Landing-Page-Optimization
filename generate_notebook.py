#!/usr/bin/env python3
"""
Script to generate the A/B Testing Jupyter Notebook.
Run: python generate_notebook.py
Then: jupyter notebook EDA_AB_Testing.ipynb
"""
...
notebook = {
    ...
    "cells": [
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 1. Chargement & Exploration des données\n"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 2. Vérification du Design Expérimental\n"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
...
with open('EDA_AB_Testing.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1, ensure_ascii=False)

print("✅ Notebook généré : EDA_AB_Testing.ipynb")
